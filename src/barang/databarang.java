...
public class databarang extends JPanel {
    ...
    if (frame instanceof uiresponsive.Mainmenu) {
        ((uiresponsive.Mainmenu) frame).showTambahDetailBarang(); // panggil method di Mainmenu
    }
});
    ...
    JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
    if (frame instanceof uiresponsive.Mainmenu) {
        ((uiresponsive.Mainmenu) frame).showTambahDataBarang(); // panggil method di Mainmenu
    }
});
    ...
    JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
    if (frame instanceof uiresponsive.Mainmenu) {
        ((uiresponsive.Mainmenu) frame).showEditDataBarang(); // panggil method di Mainmenu
    }
});
        ...
        // TABEL DATA BARANG
        // =============================
        String[] columns = {"Kode", "Nama Barang", "Kategori", "Harga", "Stok"};
        ...
        // Dummy data
        model.addRow(new Object[]{"BRG001", "Laptop Lenovo", "Elektronik", "8.500.000", "12"});
        model.addRow(new Object[]{"BRG002", "Mouse Logitech", "Aksesoris", "150.000", "37"});
        model.addRow(new Object[]{"BRG003", "Keyboard Rexus", "Aksesoris", "275.000", "25"});
        model.addRow(new Object[]{"BRG004", "Monitor LG", "Elektronik", "1.950.000", "10"});
        model.addRow(new Object[]{"BRG005", "Flashdisk Sandisk", "Penyimpanan", "85.000", "50"});
