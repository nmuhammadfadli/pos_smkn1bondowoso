...
public class tambahdatapengguna extends JPanel {
    ...
    public tambahdatapengguna() {
        ...
        imageLabel.setIcon(new ImageIcon(getClass().getResource("/Images/pengguna.png"))); // ganti sesuai path
        ...
        addField(formPanel, gbc, 0, "ID Pengguna:");
        addField(formPanel, gbc, 1, "Username:");
        addField(formPanel, gbc, 2, "Password:");
        addField(formPanel, gbc, 3, "Alamat:");
        addField(formPanel, gbc, 4, "Jabatan:");
        addField(formPanel, gbc, 5, "Nama Lengkap:");
        addField(formPanel, gbc, 6, "Hak Akses:");
        addField(formPanel, gbc, 7, "Email:");
        addField(formPanel, gbc, 8, "No. Telp:");
