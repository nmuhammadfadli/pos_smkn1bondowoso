...
public class datapengguna extends JPanel {
    ...
    if (frame instanceof uiresponsive.Mainmenu) {
        ((uiresponsive.Mainmenu) frame).showTambahDataPengguna();// panggil method di Mainmenu
    }
});
    ...
    JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this);
    if (frame instanceof uiresponsive.Mainmenu) {
        ((uiresponsive.Mainmenu) frame).showEditDataPengguna();// panggil method di Mainmenu
    }
});
        ...
        // Dummy data
        model.addRow(new Object[]{"P1001", "Miu", "Badean", "Manager", "Tiramisyuu", "miukucinglucu@gmail.com" , "082233236128"});
