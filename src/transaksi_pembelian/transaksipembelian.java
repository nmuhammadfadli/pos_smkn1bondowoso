...
public class transaksipembelian extends JPanel {
    ...
    public transaksipembelian() {
        ...
        btnPilihsup.addActionListener(e -> {
            new PilihSupplierFrame(txtNamasup);
        });
...
class PilihSupplierFrame extends JFrame {
    public PilihSupplierFrame(JTextField targetField) {
        ...
        Object[][] data = {
            {"S001", "CV Makmur Jaya", "08123456789"},
            {"S002", "PT Sumber Rezeki", "08187654321"},
            {"S003", "UD Sejahtera", "08122334455"}
        };
        DefaultTableModel model = new DefaultTableModel(data, kolom);
        JTable tabel = new JTable(model);
        tabel.setRowHeight(26);
